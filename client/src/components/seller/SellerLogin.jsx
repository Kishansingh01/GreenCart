    ...
    const onSubmitHandler = async(event)=>{
       try{
            ...
            if(data.success){
                ...
                toast.error(data.message  || "Something went wrong Emai and data is not coming from backend. Please try again.")
            }

          } catch(error){
            toast.error(error.message || "Something 1 went wrong Emai and data is not coming from backend. Please try again.")
                       }      
                                        }
