...
import toast from 'react-hot-toast';
 const Cart = () => {
    ...
    const {products,currency,cartItems,removeFromCart,getCartCount,updateCartItem, axios, 
           navigate,getCartAmount,user,setCartItems } =useAppContext()
...
const getUserAddress = async () => {
    try {
        // ✅ FIX 3: Safely grab the user ID and attach it to the URL
        const currentUserId = user._id || user.id;
        const { data } = await axios.get(`/api/address/get?userId=${currentUserId}`);
